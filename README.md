# My Demo APP-Mobile-Testing-portfolio
Manual testing for Sauce Labs My Demo App, including test cases, bug reports, and technical log analysis using ADB Logcat and Charles Proxy.
## Test cases
...
* severity: high
* Issue type : crash
* steps : 1.Open the APP (my demo) <br> 2. click on a product image (T-shirt black)
